...
local __tostring = {
    [node.name] = function(self) return self.value end,
    [node.number] = function(self) return self.value end,
    [node.val_nil] = function(self) return self.value end,
    [node.val_false] = function(self) return self.value end,
    [node.val_true] = function(self) return self.value end,
    [node.vararg] = function(self) return self.value end,
